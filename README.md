...
| 测试场景 (Topology)             | 节点规模 (Nodes) | 持续时间 (Ticks) | 吞吐量 (Ticks/sec) | 节点处理速度 (Nodes/sec)   |
| :------------------------------ | :--------------- | :--------------- | :----------------- | :------------------------- |
| **超长线性链 (Linear Chain)** | 75,001           | 10,000           | **2.72 M** | **2,044.69 亿** |
| **高扇出星型网 (High Fan-out)** | 10,001           | 2,000            | **128.20 M** | **12,821.79 亿** |
| **密集时钟振荡器 (Oscillators)**| 15,000 (100%活跃)| 1,000            | 908.39             | **1,362.58 万 (Flips/s)** |
